...
- parágrafo: `None of these recommendations are about adding complexity. They're about creating leverage.`
...
**7. Fechamento:**
> "Closing CTA text? (or 'default' to reuse: 'If this resonates, let's talk.' / 'I already have a few ideas on how I'd approach this. If you'd like to explore them together, click the red button below and we'll take it from there.')"
...
5. Slide de intro: copy fixa, sempre a mesma estrutura (não pergunte — é padrão):
   ...
   - h2/headline: `I went through your info setup (funnel) and a few things stood out.`
...
9. Slide final: CTA fixo do Instagram, texto customizado se pedido (default = copy nova do item 7).
